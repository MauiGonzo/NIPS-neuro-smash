...
def generate_images(transformer, num_images=1000,
                    start_frame=100, image_period=25):
    ...
    Args:
        ...
        nr_images    = [int] number of images to generate
    ...
    os.makedirs(os.path.join(data_dir, 'label_images'))
